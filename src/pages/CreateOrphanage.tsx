        ...
        <form className="create-orphanage-form" onSubmit={handleSubmit}>
          ...
          <fieldset>
            ...
            <div className="input-block">
              ...
              <input onChange={event => setInstructions(event.target.value)} id="instructions" />
            </div>
            ...
            <div className="input-block">
              ...
              <textarea onChange={event => setAbout(event.target.value)} id="about" maxLength={300} />
            </div>
